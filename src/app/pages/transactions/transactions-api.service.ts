...
export class TransactionsApiService {
  ...
  public addTransaction(transaction: Transaction): Observable<Transaction> {
    return this.http.post<Transaction>(`${environment.apiRoot}transactions/`, transaction);
  }

  public updateTransaction(transaction: Transaction): Observable<Transaction> {
    return this.http.put<Transaction>(`${environment.apiRoot}transactions/${transaction.id}/`, transaction);
  }
